...
if(isset($_POST['add'])) {
    ...
    if($data[0] > 1) {
        ...
        if(mysqli_query($con,$sql)) {
            ...
            echo '<script>alert("Error! Check System")</script>';
        }
    }
}
?> 
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="text-muted">All prices are in Philippine Peso (₱)</p>
                    </div>
                </div> 
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="panel panel-default">
                                    <?php $sql = "select * from room limit 0,10"; $re = mysqli_query($con,$sql); ?>
                                    <div class="panel-body">
